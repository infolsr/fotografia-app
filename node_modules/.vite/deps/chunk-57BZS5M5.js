...
var Path = class _Path extends Shape {
  ...
  getPointAtLength(length) {
    ...
    switch (cp.command) {
      ...
      case "C":
        return _Path.getPointOnCubicBezier(length / cp.pathLength, cp.start.x, cp.start.y, p[0], p[1], p[2], p[3], p[4], p[5]);
      case "Q":
        return _Path.getPointOnQuadraticBezier(length / cp.pathLength, cp.start.x, cp.start.y, p[0], p[1], p[2], p[3]);
      case "A":
...
//# sourceMappingURL=chunk-57BZS5M5.js.map
