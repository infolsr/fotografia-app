...
// Se lee la URL del backend desde las variables de entorno
  ...
  useEffect(() => {
    const createRemoteSession = async () => {
      try {
        ...
        const response = await fetch(`${API_BASE_URL}/crear-sesion-remota`, {
          method: 'POST',
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-xl text-center max-w-sm w-full relative">
        ...
        <p className="text-gray-600 mb-6">Escanea este código QR con la cámara de tu teléfono para subir fotos directamente a este pedido.</p>
