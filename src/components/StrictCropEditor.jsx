    ...
    <>
      ...
      <div className={`space-y-6 max-w-7xl mx-auto ${isLoading ? 'blur-sm pointer-events-none' : ''}`}>
        ...
        <div className="max-w-4xl mx-auto p-4 bg-luitania-sage/10 border border-luitania-sage/20 rounded-lg text-center my-6">
          ...
          <p className="text-sm text-luitania-textbrown/80 mt-1">👇 Simplemente <strong>arrastra la imagen</strong> en cada miniatura para seleccionar la parte que más te guste o has clic en Mas Opciones, para abrir un editor azanzado.</p>
        </div>
